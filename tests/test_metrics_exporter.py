...
class MetricsExporterTest(unittest.TestCase):
    def test_samples_from_limits_keeps_only_percent_left_values(self):
        ...
        self.assertIn('codex_usage_limit_percent_left{scope="default",window="5h"} 97', rendered)
        self.assertIn('codex_usage_limit_percent_left{scope="default",window="weekly"} 49', rendered)
        self.assertIn(
